 ...
 *
 * @Author: xie
 * @Time: 2016/12/8 18:03
 * @Description:
 */


public class GuideBasePager extends ViewPager {

    private boolean mAllowUserScrollable = true;
    private AutoPlayDelegate mAutoPlayDelegate;

    public GuideBasePager(Context context) {
        super(context);
    }

    public GuideBasePager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setPageChangeDuration(int duration) {
        try {
            ...
            scrollerField.set(this, new GuideBaseScoller(getContext(), duration));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
